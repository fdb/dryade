...
public class DraggableNumber extends JComponent implements MouseListener, MouseMotionListener, ComponentListener {
    ...
    private static Font SMALL_BOLD_FONT = new Font("Lucida Grande", Font.PLAIN, 11);
    ...
    public DraggableNumber() {
        ...
        numberField.setFont(SMALL_BOLD_FONT);
    ...
    public void paintComponent(Graphics g) {
        ...
        if (isEnabled()) {
            ...
            g2.setColor(TEXT_DISABLED_COLOR);
        }

        drawCenteredShadowText(g2, valueAsString(), r.width / 2, 14, DRAGGABLE_NUMBER_HIGHLIGHT_COLOR);
    }
